namespace SSLine
{
    ...
    public class ArrowLineWithText : ArrowLine
    {
        ...
        {
            this.MouseLeftButtonDown += ArrowLineWithText_MouseLeftButtonDown;
        }

        private void ArrowLineWithText_MouseLeftButtonDown(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            if (e.ClickCount>=2)
            {
